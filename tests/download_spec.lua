...
describe("download", function()
	...
	it("can checkout a different tag", function()
		...
		local result = Download.clone(download_dir, { repo = "elixir-lsp/elixir-ls", ref = "tags/v0.12.0" })

		eq("elixir-lsp/elixir-ls/tags_v0.12.0", result)
		assert.True(Path:new(download_dir, "elixir-lsp/elixir-ls/tags_v0.12.0", "mix.exs"):exists())
	end)
end)
